...
( "KAMYLLA", 20 , "61999875002", "RIACHO FUNDO 2", null),
...
( "MILENA", 70 , null, "RIACHO FUNDO 4", "milena@hotmail.com"),
...
SELECT * FROM atividade_sql pessoapessoa WHERE endereco = "RIACHO FUNDO 2" and idade > 18;
